...
export default function IdeaComments({ slug, lang, ideaTitle }: IdeaCommentsProps) {
  ...
  const publishHint =
    lang === "zh"
      ? "留言为必填，昵称与邮箱选填；未填昵称将随机生成。新留言需审核通过后会在「已有留言」中展示。"
      : "Comment is required; nickname and email are optional. A random nickname is used if you leave it blank. After approval, comments appear in the list above.";
